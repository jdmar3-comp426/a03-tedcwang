...
export const allEvensAreOdd = (arr) => {
    var allEvens = everyEven(arr, x => x%2 == 1);
    return allEvens
};
...
export const anEvenIsOdd = (arr) => {
    var anEven = someEven(arr, x => x%2 == 1);
    return anEven
};
...
export const hasExactly = (arr, test, n) => {
    var contains = filter(arr, test);
    if (contains.pass.length == n) {
        return true
    } else {
        return false
    }
